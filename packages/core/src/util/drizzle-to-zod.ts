...
// Define the JSON schema without recursion
const jsonArraySchema = z.array(z.union([literalSchema, z.array(literalSchema), z.record(literalSchema)]));
const jsonRecordSchema = z.record(z.union([literalSchema, jsonArraySchema]));

export const jsonSchema = z.union([literalSchema, jsonArraySchema, jsonRecordSchema]);
