  ...
  return (
    <section className="w-full py-12 bg-gradient-to-b  text-white">
      <div className="w-full mx-auto ">
        <h2 className="text-3xl font-extrabold sm:text-4xl mb-16 text-center w-full ">How It Works</h2>
        <motion.div 
        ...
        >
          ...
          <ArrowRight className="w-20 h-8 ttransform rotate-90 md:rotate-0 my-4 md:my-0" />
          ...
          <ArrowRight className="w-20 h-8 transform rotate-90 md:rotate-0 my-4 md:my-0" />
          <motion.div className="flex flex-col items-center " variants={itemVariants}>
            <div className=" p-6 mb-4 bg-[#00B67A]/40 rounded-full">
              <Coins className="w-16 h-16 text-[#00B67A]" />
            </div>
            <p className="text-2xl font-semibold">Stable Coins</p>
