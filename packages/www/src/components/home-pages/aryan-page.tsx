    ...
    <div className="min-h-screen flex flex-col bg-black text-white">
      ...
      <main className="flex-grow">
        ...
        <section id="services" className="py-16 bg-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-xl text-gray-300 mb-12">
              We provide comprehensive solutions to streamline fiat to crypto
              payments.
            </p>
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-gray-900 border-[#00B67A]">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#00B67A] mb-2">
                    Fiat Payments
                  </h3>
                  <p className="text-gray-300">
                    Accept traditional currency payments seamlessly, expanding
                    your user base.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-gray-900 border-[#00B67A]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-300">
                    Simplify user onboarding with familiar authentication
                    methods.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-gray-900 border-[#00B67A]">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-300">
                    Remove barriers to entry by eliminating gas fees for users.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        {/* <section className="py-16 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-black via-gray-900 to-black"></div>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <h2 className="text-3xl font-extrabold text-white sm:text-4xl mb-8 text-center">
              See one of our client
            </h2>
            <div className="w-full h-full rounded-lg overflow-hidden shadow-2xl">
              <iframe
                width="560"
                height="315"
                src="https://www.youtube.com/embed/LBxIZkRBPTU?si=jxPSnREl7s3Cv-Ud"
